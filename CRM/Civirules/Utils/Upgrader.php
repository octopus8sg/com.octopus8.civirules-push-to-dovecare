...
class CRM_Civirules_Utils_Upgrader {
  ...
  public static function checkCiviRulesActions() {
    $actions = array(
      ...
      'CRM_CivirulesActions_Activity_AddingRelationshipinDovecare' => array(
        'label' => 'Adding Relationship to Dovecare database',
        'name' => 'adding_relationship_to_dovecare',
      ),
      'CRM_CivirulesActions_Activity_ApproveEventInDovecare' => array(
        'label' => 'Approving Event In Dovecare database',
        'name' => 'approving_event_in_dovecare',
      ),
      'CRM_CivirulesActions_Activity_addingcfsvalue' => array(
        'label' => 'Adding CFS Value to Dovecare database',
        'name' => 'adding_CFSValue_to_dovecare',
      ),
      'CRM_CivirulesActions_Activity_PushingToDovecare' => array(
        'label' => 'Push to Dovecare Database',
        'name' => 'pushing_to_dovecare',
      ),
